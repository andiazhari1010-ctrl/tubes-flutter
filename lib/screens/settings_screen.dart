          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildGlossaryItem('HP (Health Points)', 'Nyawa karakter (Maks 150). Berkurang bila task daily/to-do lewat deadline tak dikerjakan, atau gagal Habit. Menyerang Boss tidak mengurangi HP.'),
                const SizedBox(height: 12),
                ...
                const SizedBox(height: 12),
                _buildGlossaryItem('Token Serang', 'Energi untuk menyerang Boss bersama party. Dapat 1 token tiap menyelesaikan task (maks ${AppState.tokenDailyCap}/hari). Tiap serangan ke Boss memakai 1 token, jadi rajin mengerjakan task = lebih banyak serangan.'),
                const SizedBox(height: 12),
                _buildGlossaryItem('Damage Boss', 'Damage = 6 + (Strength÷4) + (ATK senjata÷10) + (Level÷3). Naikkan Strength (kerjakan task Strength), pakai senjata di Shop, dan naik level untuk damage lebih besar.'),
                const SizedBox(height: 12),
                _buildGlossaryItem('Bonus Class', 'Warrior: penalti HP task telat -50%. Mage: damage Boss +50%. Rogue: 30% Critical (damage x2). Healer: +15 HP regen tiap hari baru.'),
              ],
            ),
          ),
